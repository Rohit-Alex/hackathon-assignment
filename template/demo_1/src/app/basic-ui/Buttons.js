            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description">
                  Add class <code>.btn-gradient-&#123;color&#125;</code> for
                  gradient buttons
                </p>
                <div className="template-demo">
                  ...
                  <button
                    type="button"
                    className="btn btn-gradient-light btn-fw"
                  >
                    Light
                  </button>
                  <button
                    type="button"
                    className="btn btn-gradient-dark btn-fw"
                  >
                    Dark
                  </button>
              ...
              <div className="card-body">
                ...
                <p className="card-description">
                  Add class <code>.btn-&#123;color&#125;</code> for buttons in
                  theme colors
                </p>
                <div className="template-demo">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="card-description">
                      ...
                      use <code>.btn-icon-prepend</code>
